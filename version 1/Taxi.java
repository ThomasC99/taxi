...
class Taxi {
	...
	static void chicago_south_clark_street_west_congress_parkway_south() {
		System.out.println("1. Turn left on West Congress Parkway");
		System.out.println("2. Continue on South Clark Streek");
	} // 320
	static void chicago_south_clark_street_west_van_buren_street_west() {
		System.out.println("1. Turn left on South Clark Street");
		if (sign >= 1278) {
			System.out.println("   New York - 1,278");
		}
		if (sign >= 3242) {
		...
		if (sign >= 3392) {
			System.out.println("   Mexico City - 3,392");
		}
		System.out.println("2. Continue straight on West Van Buren Street");
		if (sign >= 0.55) {
			System.out.println("   Chicago - 0.55");
		}
		int choice;
		do {
			choice = input.nextInt();
		...
		System.out.println("");
		if (choice == 1) {
			chicago_south_clark_street_west_congress_parkway_south();
	...
	static void chicago_south_federal_street_west_van_buren_street_south () {
		...
		System.out.println("2. Turn right on West Van Buren Avenue");
		if (sign >= 1278) {
			System.out.println("   New York - 1,278");
		}
		if (sign >= 3392) {
		...
		if (choice == 1) {
			...
			chicago_south_clark_street_west_van_buren_street_west();
		}
	}
	...
	static void i_90_i_94_express_east () { // TODO
		System.out.println("1. Continue on I-90 / I-94 express east");
		if (sign >= 1271) {
			System.out.println("   New York - 1,271");
		}
		System.out.println("2. Take exit to I-90 east, I-94 east");
		if (sign >= 12.1) {
			System.out.println("   Chicago - 12.1");
		}
		if (sign >= 3253) {
			System.out.println("   Los Angeles - 3,253");
		}
	}
	static void i_290_illinois_west () { // TODO
		System.out.println("1. Continue on I-290 west");
		if (sign >= 5.6) {
			System.out.println("   Chicago - 5.6");
		}
		if (sign >= 3241) {
			System.out.println("   Los Angeles - 3,241");
		}
		System.out.println("2. Take exit for I-90 east, I-90 west, I-94 east, I-94 west, South Union Avenue, West Taylor Street");
		if (sign >= 1270) {
			System.out.println("   New York - 1,270");
		}
		if (sign >= 3393) {
			System.out.println("   Mexico City - 3,393");
		}
		int choice;
		do {
			choice = input.nextInt();
		...
		System.out.println("");
		if (choice == 1) {
			// i_290_illinois_west_26b(); TODO
		} else if (choice == 2) {
			System.out.println("1. Take ramp to I-90 east, I-94 east, South Union Avenue, West Talor Street");
			System.out.println("2. Take ramp to I-90 west, I-94 west");
			if (sign >= 6.1) {
				System.out.println("   Chicago - 6.1");
			}
			if (sign >= 3262) {
				System.out.println("   Los Angeles - 3,262");
			}
			if (sign >= 3393) {
				System.out.println("   Mexico City - 3,393");
			}
